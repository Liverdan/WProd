...
if ( ! function_exists( 'oblique_setup' ) ) :
	/**
	 * Définit les valeurs par défaut des rubriques et prend en charge les différentes fonctionnalités de WordPress.
	*
	* Notez que cette fonction est accrochée dans le hook after_setup_theme, qui
	* s'exécute avant le hook init. Le hook init est trop tard pour certaines fonctionnalités, telles que
	* comme indiquant le support pour les vignettes post.
	 */
	function oblique_setup() {
		/*
		* Rendre le thème disponible pour la traduction.
		* Les traductions peuvent être classées dans le répertoire / languages /.
		* Si vous construisez un thème basé sur Oblique, utilisez une recherche et remplacez
		* pour changer 'oblique' au nom de votre thème dans tous les fichiers modèles
		 */
